...
import logoVar from '@/images/logos/var.svg'
...
function SocialLink({ icon: Icon, ...props }) {
  return (
    <Link href={props.hre} className='group -m-1 p-1' {...props}>
          ...
          <li key={roleIndex} className='flex gap-4'>
            ...
            <dl className='flex flex-auto flex-wrap gap-x-2'>
              ...
              <dd className='ml-auto text-xs text-zinc-400 dark:text-zinc-500'>
                {/* @ts-ignore */}
                <time>{role.start.label ?? role.start}</time>
                <span aria-hidden='true'>—</span>
                {/* @ts-ignore */}
                <time>{role.end.label ?? role.end}</time>
              </dd>
            </dl>
          </li>
        ))}
      ...
      <Container className='mt-9'>
        <div className='max-w-2xl'>
          ...
          <div className='mt-6 flex gap-6'>
            <SocialLink
              href='https://twitter.com/hirahara_cs'
            ...
            {/*/>*/}
            <SocialLink
              href='https://github.com/n-hiraha'
...
export async function getStaticProps() {
  ...
  return {
    props: {
      blogs: blogs.slice(0, 4).map(({ component, ...meta }) => meta),
    },
  }
}
